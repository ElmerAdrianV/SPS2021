...
public class RandomFactsAboutMeServlet extends HttpServlet {
    ...
    private ArrayList<FactAboutMe> getFactsAboutMeEN() {
        ...
        factsAboutMeEN.add(new FactAboutMe("images/footballer.png", "footballer",
                "My frustrated dream is to be a footballer (soccer)"));
        factsAboutMeEN.add(new FactAboutMe("images/elmer-elephant.jpg", "Elmer elephant",
        ...
        factsAboutMeEN.add(new FactAboutMe("images/teacher.png", "Teacher Icon",
    ...
    private ArrayList<FactAboutMe> getFactsAboutMeES() {
        ...
        factsAboutMeES.add(
                new FactAboutMe("images/birthdayCake.png", "Pastel de cumpleaños", "Mi cumpleaños es el 7 de Agosto"));
        factsAboutMeES.add(new FactAboutMe("images/ninaGP.jpeg", "Cuyo", "Mi mascota es un cuyo llamdo Nina"));
        factsAboutMeES
                .add(new FactAboutMe("images/footballer.png", "Futbolista", "Mi sueño frustado es ser futbolista"));
        factsAboutMeES.add(new FactAboutMe("images/elmer-elephant.jpg", "Elmer el elefante",
        ...
        factsAboutMeES.add(new FactAboutMe("images/teacher.png", "Icono de profesor",
